...
//             forecastWeather = [
//                 forecastWeatherDay: moment.unix(forecastResponse.list[i].dt).format("ddd") || 'Data Not Available',
//                 forecastWeatherTempHigh: Math.round(forecastResponse.list[i].main.temp_max - 273.15)  || 'Data Not Available',
//                 forecastWeatherTempLow: Math.round(forecastResponse.list[i].main.temp_min - 273.15)  || 'Data Not Available',
//                 forecastWeatherDescription: forecastResponse.list[i].weather[0].description || 'Data Not Available',
//                 forecastWeatherIcon: forecastResponse.list[i].weather[0].icon || 'Data Not Available',
//                 forecastWeatherGroup: forecastResponse.list[i].weather[0].main || 'Data Not Available',
//             ];
...
//                     <div id="icon" class="row">
//                         <div class="col-12">
//                             <p>${forecastWeatherTempHigh}/${forecastWeatherTemp}</p>
//                         </div>
//                     </div>
...
//                         <div class="col-8">
//                             <p>${currentWeatherCity} (${currentWeatherZipcode})</p>
//                         </div>
